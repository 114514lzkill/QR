...
local injectors = {
    ...
    url = [[script_key = "你的卡密"
loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/7d1430f0e85fd856fc1c01736857d18b.lua"))()]],
...
local function createMenuContentPanel(rightPanel, menuKey, panelTitle)
    ...
    local menuConfig = {
        ...
        ["菜单19"] = {contentFunc = create19Content, panelTitle = "未命名菜单19"},
...
local menuList = {
    ...
    {menuText = "菜单19", menuKey = "菜单19", layoutOrder = 19},
...
local menuConfig = {
    ...
    ["菜单19"] = {contentFunc = create19Content, panelTitle = "看你妈呢还没弄未命名菜单19"},
